...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        console.log('Received data:', { partnershipType, email, telegramId });

        const scriptUrl = process.env.GOOGLE_SCRIPT_URL;
        const response = await fetch(`${scriptUrl}?sheet=Partnership&data=${encodeURIComponent(JSON.stringify({partnershipType, email, telegramId}))}`);
